...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!captcha.ok) {
      console.warn('[quiz_lead] reCAPTCHA rejected', captcha.reason, captcha.score);
      ...
      await resend.emails.send({
        ...
        html: `
          <div style="font-family:sans-serif;max-width:600px">
            ...
            <p>Thanks for completing our Home Finder Quiz! Based on your answers, one of our local experts will reach out personally with home recommendations matched to your criteria.</p>
