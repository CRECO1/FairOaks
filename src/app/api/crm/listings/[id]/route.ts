...
const ALLOWED = ['name','address','city','state','zip','type','status','asking_price','sq_ft','lot_size','year_built','description','notes','highlights','flyer_type','co_agent_id','listing_agent_id','assigned_agent_ids','is_restricted'];
