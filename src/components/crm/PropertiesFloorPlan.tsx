...
const SUITES: SuiteDef[] = [
  ...
  { key: 'central_texas', building: 'bldg2', floor: 1, shape: { type: 'rect', x: 715, y: 170, w: 190, h: 230 }, name: { x: 810, y: 276, lines: ['Central Texas', 'Tree Service'], size: 18 }, num: { x: 810, y: 339 }, defNumber: '3102', defColor: 'green' },
  { key: 'emergency_diagnostic', building: 'bldg2', floor: 1, shape: { type: 'rect', x: 905, y: 170, w: 235, h: 230 }, name: { x: 1022, y: 286, lines: ['Emergency', 'Diagnostic'], size: 20 }, num: { x: 1022, y: 345 }, defNumber: '3115', defColor: 'rose' },
...
const GEO: Record<string, FloorGeo> = {
  'bldg1-1': {
    ...
    doorErase: [[320, 372, 365, 372], [395, 372, 440, 372], [840, 440, 885, 440], [1085, 440, 1130, 440], [315, 690, 360, 690], [395, 690, 440, 690], [1075, 690, 1120, 690], [440, 444, 440, 489]],
    doors: [
      ...
      // corridor → centre area door (left wall of centre rect, swings right into bathrooms/conference)
      { d: 'M 485 444 A 45 45 0 0 1 440 489', leaf: [440, 444, 485, 444] },
    ],
    extraText: [
  ...
  'bldg2-1': {
    ...
    int: [[110, 400, 1140, 400], [320, 170, 320, 400], [490, 170, 490, 400], [600, 170, 600, 400], [715, 170, 715, 400], [905, 170, 905, 400], [375, 590, 1140, 590], [375, 590, 375, 910], [560, 590, 560, 910], [715, 590, 715, 910], [905, 590, 905, 910]],
    fills: [
